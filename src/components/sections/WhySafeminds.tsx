const features = [
  {
    ...
    title: 'Gesetzlich auf der sicheren Seite',
    desc: '§12 ArbSchG und DGUV V2 — alle Kurse entsprechen den aktuellen Vorschriften. Wir halten sie aktuell, wenn sich etwas ändert.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Fast jeder besteht',
    desc: 'Wer eine Frage falsch beantwortet, bekommt sofort eine Erklärung. Dann nochmal. Fast alle schaffen es beim ersten Mal.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Jede Muttersprache',
    desc: 'Deutsch, Polnisch, Türkisch, Rumänisch und mehr — jeder Mitarbeiter liest und hört in seiner Sprache. Kein Übersetzen, keine Missverständnisse.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    desc: 'Direkt nach Abschluss als PDF. Mit Datum, Name und Kurs-Details — so wie es Prüfer sehen wollen.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Handy, Tablet, PC — egal',
    desc: 'Mitarbeiter starten am Handy und machen am PC weiter. Fortschritt wird automatisch gespeichert.',
  },
  {
    icon: (
      <svg className="w-5 h-5 text-[#3b82f6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Heute noch starten',
    desc: 'Kein IT-Projekt, keine Installation. Konto erstellen, Mitarbeiter einladen — und der erste Kurs läuft heute noch.',
  },
]
    ...
    <section className="py-24" style={{ background: '#f8fafc' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="text-xs font-bold text-[#3b82f6] uppercase tracking-widest mb-3">Was SafeMinds ausmacht</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0f172a]">
            Kein Seminar. Kein Dolmetscher. Keine Papierstapel.
          </h2>
        </div>
