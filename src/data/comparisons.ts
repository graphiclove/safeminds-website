...
export const comparisons: Comparison[] = [
  // ── Unterweisung24 ──────────────────────────────────────────────────────────
  {
    ...
    benefits: [
      { icon: 'globe', title: 'Mehrsprachig — für gemischte Teams', desc: 'SafeMinds bietet Unterweisungen auf Deutsch, Polnisch, Türkisch, Rumänisch und weiteren Sprachen — ohne Aufpreis. Für Betriebe mit internationalen Mitarbeitenden ein entscheidender Unterschied.' },
      { icon: 'check-circle', title: 'Bestanden-Garantie', desc: 'Wer eine Frage falsch beantwortet, bekommt die Erklärung und kann die Frage wiederholen. Echtes Verstehen statt reines Abhaken.' },
      { icon: 'smartphone', title: 'Entwickelt für Smartphones', desc: 'SafeMinds läuft vollständig auf jedem Smartphone ohne App-Download — ideal für Mitarbeitende ohne festen Büroarbeitsplatz.' },
      { icon: 'zap', title: 'Schneller Einstieg', desc: 'Konto erstellen, Mitarbeitende einladen — erste Unterweisung noch am selben Tag. Kein IT-Projekt, keine Einrichtungszeit.' },
      { icon: 'bell', title: 'Automatische Erinnerungen', desc: 'SafeMinds erinnert Mitarbeitende selbstständig, wenn eine Unterweisung zur Wiederholung fällig ist.' },
      { icon: 'factory', title: 'Branchenspezifisch', desc: 'Kurse zugeschnitten auf konkrete Gefährdungen in Bau, Pflege, Produktion, Logistik und Gastronomie.' },
    ],
    differentiators: [
  ...
  // ── WEKA ────────────────────────────────────────────────────────────────────
  {
    ...
    benefits: [
      { icon: 'target', title: 'Klarer Fokus', desc: 'SafeMinds macht genau eine Sache und ist darin optimiert: Mitarbeitende in Deutschland rechtssicher unterweisen. Kein Verlag-Gesamtportfolio, das man durchsuchen muss.' },
      { icon: 'scale', title: 'Transparente Preise', desc: 'WEKA arbeitet mit individuellen Jahreslizenzen auf Anfrage. Bei SafeMinds sind die Konditionen von Anfang an klar — kein Angebotsprozess nötig.' },
      { icon: 'globe', title: 'Mehr Sprachen ohne Aufpreis', desc: 'WEKA bietet DE + EN, weitere auf Anfrage. SafeMinds enthält Polnisch, Türkisch, Rumänisch und mehr standardmäßig — ohne Mehrkosten.' },
      { icon: 'zap', title: 'Direkt loslegen', desc: 'Kein SCORM-Export, kein LMS nötig. SafeMinds ist sofort als SaaS nutzbar — Konto erstellen, Mitarbeitende einladen, fertig.' },
      { icon: 'check-circle', title: 'Bestanden-Garantie', desc: 'Fehlerhafte Antworten werden erklärt und Fragen wiederholt. Nahezu 100 % Abschlussquote — auch bei Mitarbeitenden ohne Vorkenntnisse.' },
      { icon: 'bell', title: 'Automatische Erinnerungen', desc: 'SafeMinds erinnert Mitarbeitende selbstständig bei fälligen Wiederholungsunterweisungen.' },
    ],
    differentiators: [
  ...
  // ── Haufe ───────────────────────────────────────────────────────────────────
  {
    ...
    benefits: [
      { icon: 'target', title: 'Fokus auf das Wesentliche', desc: 'Haufe deckt viel ab — Arbeitsschutz ist eines von vielen Modulen. SafeMinds ist ausschließlich für Unterweisungen entwickelt und darin konsequent optimiert.' },
      { icon: 'scale', title: 'Transparente Preisgestaltung', desc: 'Haufe arbeitet mit individuellen Angeboten. SafeMinds ist klar bepreist — passend für Betriebe, die ohne langen Angebotsprozess starten wollen.' },
      { icon: 'globe', title: 'Mehrsprachig ohne Aufpreis', desc: 'Für Teams mit internationalen Mitarbeitenden bietet SafeMinds Unterweisungen in 4+ Sprachen standardmäßig — ohne Mehrkosten.' },
      { icon: 'smartphone', title: 'Mobil an jedem Arbeitsplatz', desc: 'SafeMinds funktioniert vollständig auf Smartphones — ideal für Mitarbeitende ohne Büroarbeitsplatz.' },
      { icon: 'zap', title: 'Schnell startklar', desc: 'Kein Implementierungsprojekt. SafeMinds ist in unter 5 Minuten einsatzbereit — Konto erstellen, Mitarbeitende einladen, fertig.' },
      { icon: 'check-circle', title: 'Bestanden-Garantie', desc: 'Fehler werden erklärt und Fragen wiederholt — nahezu 100 % Abschlussquote, auch ohne Vorkenntnisse.' },
    ],
    differentiators: [
  ...
  // ── Präsenzseminar ──────────────────────────────────────────────────────────
  {
    ...
    benefits: [
      { icon: 'clipboard', title: 'Rechtssicher ohne Papierchaos', desc: 'Online-Unterweisungen dokumentieren sich automatisch. Kein Sammeln von Unterschriftslisten, keine Ablageordner — alles revisionssicher digital.' },
      { icon: 'clock', title: 'Kein Produktionsausfall', desc: 'Bei Präsenzseminaren fehlt das gesamte Team gleichzeitig. Mit SafeMinds unterweist jeder in seiner Pause oder Freischicht — ohne Betriebsunterbrechung.' },
      { icon: 'scale', title: 'Deutlich geringere Gesamtkosten', desc: 'Ein Präsenzseminar kostet inklusive Ausfallzeit oft 50–200 € pro Person. SafeMinds liegt weit darunter — und skaliert ohne Mehrkosten auf viele Standorte.' },
      { icon: 'globe', title: 'Mehrsprachig ohne Dolmetscher', desc: 'Bei gemischten Teams braucht die Präsenzschulung Dolmetscher oder separate Termine. SafeMinds übersetzt automatisch.' },
      { icon: 'smartphone', title: 'Jederzeit und überall', desc: 'Keine Terminkoordination, kein Seminarraum. SafeMinds läuft auf jedem Smartphone, wann es passt.' },
      { icon: 'refresh', title: 'Wiederholung jederzeit möglich', desc: 'Wenn jemand eine Unterweisung erneut durchgehen möchte, ist das mit einem Klick möglich — kein neuer Seminartermin nötig.' },
    ],
    differentiators: [
  ...
  // ── LMS ─────────────────────────────────────────────────────────────────────
  {
    ...
    benefits: [
      { icon: 'zap', title: 'Sofort einsatzbereit', desc: 'Ein LMS ist ein leeres System — Kursinhalte, Zertifikate und Compliance-Logik müssen erst aufgebaut werden. SafeMinds ist von Tag 1 vollständig funktionsfähig.' },
      { icon: 'scale', title: '§12 ArbSchG — von Anfang an', desc: 'Die Anforderungen an Arbeitsschutz-Unterweisungen in Deutschland sind spezifisch. SafeMinds wurde genau dafür entwickelt — nicht nachgerüstet.' },
      { icon: 'clipboard', title: 'Inhalte inklusive', desc: 'Statt selbst Kurse erstellen zu müssen, haben Sie bei SafeMinds sofort Zugriff auf fertige, rechtssichere Unterweisungen für Ihre Branche.' },
      { icon: 'globe', title: 'Mehrsprachigkeit ohne Eigenaufwand', desc: 'Mehrsprachige Inhalte in einem LMS selbst zu erstellen ist aufwändig. Bei SafeMinds sind 4+ Sprachen bereits enthalten.' },
      { icon: 'scale', title: 'Gesamtkosten im Blick', desc: 'LMS-Lizenzen wirken günstig — hinzu kommen Kursproduktion, IT-Einrichtung, Pflege und Aktualisierungen. SafeMinds ist all-inclusive.' },
      { icon: 'refresh', title: 'Inhaltspflege inklusive', desc: 'Wenn sich Gesetze oder Normen ändern, aktualisiert SafeMinds die Kursinhalte. In einem LMS liegt das in Ihrer Verantwortung.' },
    ],
    differentiators: [
